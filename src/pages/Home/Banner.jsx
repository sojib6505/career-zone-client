...
export default function Banner() {
    return (
        <div
            className=" md:w-7xl p-5  mx-auto grid md:grid-cols-2  md:gap-5 items-center  pb-10"
        >
            <div className="col-span-1 space-y-5 md:space-y-10">
                ...
                <div>
                    <input className=" absolute rounded-xl w-80 md:w-130 p-4 bg-base-100" type="text" />
                    <button className="relative btn btn-primary left-58 md:left-108 top-2">Search</button>
            ...
            <div
                ...
                <motion.div
                    ...
                    transition={{
                     ...
                     className=" w-50 md:w-80  left-30 ">
